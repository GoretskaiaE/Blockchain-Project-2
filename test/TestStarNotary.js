...
it('can add the star name and star symbol properly', async () => {
    ...
    let tokenId = 6;
    let instance = await StarNotary.deployed();
    await instance.createStar('Star to test name and symbol properties', tokenId, { from: accounts[0] });
...
it('lets 2 users exchange stars', async () => {
    ...
    let tokenId1 = 10;
    let instance = await StarNotary.deployed();
    await instance.createStar('Star 10', tokenId1, { from: accounts[2] });

    let tokenId2 = 11;
    await instance.createStar('Star 11', tokenId2, { from: accounts[1] });
...
it('lets a user transfer a star', async () => {
    ...
    let tokenId = 12;
    let instance = await StarNotary.deployed();
    await instance.createStar('Star 12', tokenId, { from: accounts[0] });
...
it('lookUptokenIdToStarInfo test', async () => {
    ...
    assert.equal(await instance.lookUptokenIdToStarInfo.call(tokenId), 'Another awesome Star!')
});